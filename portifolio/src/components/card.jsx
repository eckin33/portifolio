      ...
      <div className="w-1/2 flex flex-col justify-center pr-4 mr-4">
        ...
        <CardFooter className={"justify-center gap-8"}>
          <a href={props.projeto_link} target="_blank">
            <button className="w-42 pt-2 pb-2 pr-2 pl-2 mt-6 rounded-sm cursor-pointer bg-blue-400 text-slate-800 font-bold flex items-center justify-center gap-2.5 text-nowrap hover:scale-105 transition-transform">Visitar Projeto
