    ...
    <Card className="relative mx-auto w-full h-124 pt-0 flex-row pb-0">
      <div className="w-1/2 relative flex flex-col justify-center items-center">
        <img
          ...
          className="relative z-20 h-auto w-full object-cover rounded-xl imgs-port"
        />
      </div>
      <div className="w-1/2 flex flex-col justify-center ">
        ...
        <CardFooter className={"justify-center gap-8"}>
          <button className="w-42 pt-2 pb-2 pr-2 pl-2 mt-6 rounded-sm cursor-pointer bg-blue-400 text-slate-800 font-bold flex items-center justify-center gap-2.5 text-nowrap">Visitar Projeto
          ...
          <button className="w-32 p-2 mt-6  border rounded-sm cursor-pointer flex items-center justify-center gap-2.5">
            Código
